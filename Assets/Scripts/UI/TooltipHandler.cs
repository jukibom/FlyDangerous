...
public class TooltipHandler : MonoBehaviour {
    ...
    private void OnEnable() {
        _originalColor = textField.color;
        _tooltipHandlers = parentGameObject.GetComponentsInChildren<FdTooltip>(true).ToList();
        foreach (var tooltipHandler in _tooltipHandlers) {
            tooltipHandler.OnTextChange += UpdateText;
        }
    }
    ...
    IEnumerator TextUpdateAnimation() {
    ...
    IEnumerator SetBestFitFontStyle() {
