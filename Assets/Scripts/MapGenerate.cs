...
public class MapGenerate : MonoBehaviour
{
    ...
    public MapNoise.NormalizeMode noisenormalize;
    ...
    public void drawmapineditor()
    {
        ...
        {
             display.DrawMesh(MeshGenerator.GenerateTerrainMesh(mapdata.heightmap, meshheightmult, Meshheightcurve, editorpreviewlod), TextureGenerator.TexturefromeColormap(mapdata.colormap, MapChunkSize, MapChunkSize));
        }
    }
    ...
    {
        float[,] noisemap = MapNoise.GenerateNoiseMap(MapChunkSize, MapChunkSize, seed, noisescale, octaves, persistance, lacunarity,center + Offset,noisenormalize);
