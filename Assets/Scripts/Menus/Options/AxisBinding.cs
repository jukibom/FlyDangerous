...
namespace Menus.Options {
    ...
    public class AxisBinding : MonoBehaviour {
        ...
        [Header("Axis Attributes")]
        [Tooltip("Sets the text label on all child elements")]
        [SerializeField] private string axisBindingLabel;
        [Tooltip("Determines what language to use in labels")]
        [SerializeField] private AxisBindingOrientation axisBindingOrientation;

        [Header("Axis Action Reference")]
        [Tooltip("This action ref should have three groups of primary and secondary bindings - one for full range (index 0 and 1), one for positive axis (3 and 6) and one for negative axis (4 and 7)")]
        [SerializeField] private InputActionReference action;
        
        [Header("Rebind Overlay Components")]
        [Tooltip("The component to show while binding action is in progress")]
        [SerializeField] private GameObject rebindOverlay;
        [Tooltip("The text value to manipulate while binding action is in progress")]
        [SerializeField] private Text rebindText;
        
        [Header("Internal Components - Don't touch")] 
        [SerializeField] private Text fullAxisLabel;
